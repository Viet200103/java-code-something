...
public class UpdateServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        boolean isAdmin = request.getParameter("checkbox_admin") != null;
        ...
        try {
            ...
            boolean isUpdated = registrationDao.updateAccount(username, password, isAdmin);
            ...
            log("UpdateServlet_ClassNotFoundException: " + ex.getMessage());
