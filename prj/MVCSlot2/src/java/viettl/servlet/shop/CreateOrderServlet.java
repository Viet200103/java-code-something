...
public class CreateOrderServlet extends HttpServlet {
    ...
    private String ERROR_PAGE = "cannot_create_order.html";
    private String INPUT_ADDRESS_PAGE = "inputaddress.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (userAddress != null) {
            try {
                ...
                String orderId = orderDao.makeOrder(userAddress, cart);
