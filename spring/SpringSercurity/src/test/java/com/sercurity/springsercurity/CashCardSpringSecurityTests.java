...
public class CashCardSpringSecurityTests {
    ...
    @Test
    void shouldNotAllowTokenWithAnInvalidAudience() throws Exception {
    ...
    void shouldShowAllTokenValidationErrors() throws Exception {
        ...
        this.mvc.perform(MockMvcRequestBuilders.get("/cashcards")
                ...
                MockMvcResultMatchers.jsonPath("$.errors..description").value(
                        Matchers.containsInAnyOrder(
                                Matchers.containsString("Jwt expired"),
                                Matchers.containsString("aud claim is not valid")
                        )
                )
        );
    }
